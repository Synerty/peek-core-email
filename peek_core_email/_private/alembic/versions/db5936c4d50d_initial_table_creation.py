...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['taskId'], ['core_email.Task.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    schema='core_email'
    )
    op.create_index('idx_TaskAction_taskId', 'TaskAction', ['taskId'], unique=False, schema='core_email')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('idx_TaskAction_taskId', table_name='TaskAction', schema='core_email')
    op.drop_table('TaskAction', schema='core_email')
    ...
    op.drop_table('Task', schema='core_email')
    op.drop_table('Setting', schema='core_email')
    op.drop_table('Activity', schema='core_email')
    # ### end Alembic commands ###
