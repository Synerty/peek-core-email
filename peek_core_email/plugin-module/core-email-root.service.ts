...
import {inboxPluginName} from "./core-email-names";
...
@Injectable()
export class CoreEmailRootService extends ComponentLifecycleEventEmitter {
    tasks: TaskTuple[] = [];
    ...
    constructor(private userService: UserService,
        ...
        this.alertSound = PeekModuleFactory
            .createSound('/assets/peek_core_email/alert.mp3');
